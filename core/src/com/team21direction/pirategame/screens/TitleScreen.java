...
/**
 * Title screen of the game, shown upon start up or reverting to main menu.
 */
public class TitleScreen implements Screen {
   ...
   *
   * @param game the PirateGame object to allow this screen to trigger a screen change when the play
   *     button is pressed.
   */
  ...
  public void loadGame(String saveSelect) {
    ...
    try (InputStream input = new FileInputStream("save" + saveSelect + ".properties")) {
      ...
      loadedGame.player.setPosition(
          Float.parseFloat(config.get("x").toString()),
          Float.parseFloat(config.get("y").toString()));
