...
public class MainScreen implements Screen {
  ...
  public MainScreen(PirateGame game, String difficulty) {
    ...
    shop = new Shop(shopBatch, player);
  }
  ...
  @Override
  public void show() {
    // InputMultiplexer is due to the scene focus changing between the main stage and the shop.
  ...
  public void render(float delta) {
    ...
    // 'lerping' makes the camera appear to slightly lag behind the player in order to give the
    // illusion of more
    // player control.
    float lerp = 5f;
    ...
    // HUD drawn over the top of the rest
    batch.begin();
    font.draw(
        batch,
  ...
  /**
   * Gets collisions between the parameters and every GameActor in the game
   *
   * @param x the x-coordinate
   * @param y the y-coordinate
   * @return the instance of GameActor that is colliding with the x and y parameters, or none.
   */
  ...
  /** Update the keyboard and handle movement */
