...
public class Ship extends GameActor {
  ...
  /**
   * Get the instance of the college the ship belongs to
   *
   * @return the college instance
   */
   ...
   *
   * @return a String, the college's name.
   */
  ...
  /**
   * Sets the college that the ship belongs to. This also changes the appearance of the ship.
   *
   * @param playerCollege the new college for the ship to belong to.
   */
  ...
  /**
   * Applies a powerup to the ship. This is only applicable to a player.
   *
  ...
  /**
   * Removes all powerups from the ship.
   */
